...
# --- NOUVEAU TEST HEALTH ---
def test_health_check(base_url_predict):
    """Test de la route de santé (Healthcheck)"""
    try:
        response = requests.get(f"{base_url_predict}/health")
    except requests.exceptions.ConnectionError:
        pytest.fail("L'API n'est pas accessible (Connection Refused)")
