...
class Preprocessor:
    def __init__(self, tfidf, input_model=None, batch_size=32):
...
def preprocess_data(
    ...
    preprocessor = Preprocessor(tfidf=tfidf, input_model=input_model, batch_size=32)
    ...
    return X_train_full, X_val_full, y_train, y_val, tfidf
